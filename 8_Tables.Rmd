...
caption = "Modeled and design-based indices for the assessment model with associated log-scale standard error estimates (se_log). The WCGBT and Triennial Surveys were standardized using the VAST geostatistical software and are in units of metric tons."
