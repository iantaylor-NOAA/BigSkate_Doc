...
The Sigma values associated with the 2019 spawning biomass (calculated from the normal approximation and converted to the log-standard deviation of a lognormal distibution) was 0.35, well below the minimum 1.0 value associated with Category 2, the most likely classification for this assessment.
