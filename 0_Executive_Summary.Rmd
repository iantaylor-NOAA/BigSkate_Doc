...
(95% asymptotic interval: $\pm$ `r Depl_mod1_CI`) (Figure \ref{fig:ts9_unfished_with_95_asymptotic_intervals_intervals}). 
...
**$\color{red}{\text{Template in Table h and associated discussion to be filled in during the STAR panel}}$**
...
Potential OFLs projected by the model are shown in Table \ref{tab:OFL_projection}.  These values are based on an SPR target of 50%, a P* of 0.45, and a time-varying Category 2 Sigma which creates the buffer shown in the right-hand column.
