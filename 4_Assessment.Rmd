...
Results of these sensitivities are shown in Figures \ref{fig:Sensitivity_sel_and_Q} to \ref{fig:Sensitivity_catch}, and Tables \ref{tab:Sensitivity_sel_and_Q} to \ref{tab:Sensitivity_catch}.
...
The sensitivity analysis in which historical catch was adjusted to match a time series of fishing mortality for Petrale Sole (IAN, FINISH THIS)
