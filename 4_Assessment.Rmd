...
Likelihood profiles were conducted over $log(R_0)$, stock-recruit steepness ($h$) and natural mortality ($M$). Results of these profiles are shown in Figures \ref{fig:profile_logR0} to \ref{fig:profile_M_compare1_spawnbio}.
