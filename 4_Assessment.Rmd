...
Results of these sensitivity analyses are shown in Figures \ref{fig:Sensitivity_sel_and_Q} to \ref{fig:Sensitivity_catch}, and Tables \ref{tab:Sensitivity_sel_and_Q} to \ref{fig:Sensitivity_catch3}. More detailed descriptions of each group of sensitivities is provided below.
