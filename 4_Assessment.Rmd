...
Time-series of estimated stock size over time are shown in Table \ref{tab:Timeseries_mod1} and in Figures \ref{fig:ts7_Spawning_biomass_(mt)_with_95_asymptotic_intervals_intervals} to \ref{fig:SR_curve2}.
