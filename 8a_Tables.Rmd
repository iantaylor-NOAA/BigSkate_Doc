...
<!-- *********** Sensitivity to Biological and other assumptions ******************************* --> 
...
```{r, results = 'asis'}
    ...
    # Read in/organize sensitivity file, change column names, caption
    Sens_model1 = read.csv('./txt_files/Sensitivities_bio_and_misc.csv')
    # colnames(Sens_model1) = c('Label', 
    #                           'Base (Francis weights)',
    #                           'Default weights',
    #                           'Harmonic mean weights',
    ...
    Sens_model1.table = xtable(Sens_model1, 
                               ...
                               label = 'tab:Sensitivity_bio_and_misc', digits = 2)    
