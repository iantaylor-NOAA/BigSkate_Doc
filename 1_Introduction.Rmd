...
In 2012, the Big Skate was moved from genus *Raja* to the new genus *Beringraja* together with the Mottled Skate (*B. pulchra*) [@Ishihara2012].  These are the only two skates with multiple embryos per egg case, and they are very similar mophologically and genetically [@Bizzarro2019].
...
```{r, results='asis'}
#
Life_History = read.csv('./txt_files/BigSkate_LifeHistory.csv')

colnames(Life_History) = c("Region","Sex",
                           "1st Maturity (TL cm)",
                           "50% Maturity (TL cm)",
                           "Max Age (year)",
                           "1st Maturity (year)",
...
align(Life_History.table) = c('l', 'l',
                              ...
                              '>{\\centering}p{0.8in}',
                              '>{\\centering}p{0.8in}')
    # CSV: './txt_files/BigSkate_LifeHistory.csv'
    # Catch table section in R_exec_summary_fig_tables.R
    # Print the table sideways


 print(Life_History.table,
 ...
 #       scalebox = .6,
 #       align = TRUE,
        hline.after = c(-1, 0, nrow(Life_History.table)))
...
## Map
A map showing the area of the U.S. West Coast Exclusive Economic Zone covered by this stock assessment is provided in Figure \ref{fig:boundary_map}.
...
No information is available on any fishery for Big Skate in Mexican waters, however to the extent that they do occur, which is rarely, they may be taken in the artisanal fishery.
